...
$(function () {
    ...
    $(".view_nav li").click(function () {
        ...
        switch (index){
            case 0:$viewBigImg.attr("src","../images/about16_QT/view_product/"+dec+"/1.jpg");
                break;
            case 1:$viewBigImg.attr("src","../images/about16_QT/view_product/"+dec+"/2.jpg");
                break;
            case 2:$viewBigImg.attr("src","../images/about16_QT/view_product/"+dec+"/3.jpg");
                break;
            case 3:$viewBigImg.attr("src","../images/about16_QT/view_product/"+dec+"/4.jpg");
                break;
            case 4:$viewBigImg.attr("src","../images/about16_QT/view_product/"+dec+"/5.jpg");
                break;
        }
    });
    /*tab链接*/
